								...
								<div class="col-sm-4">
									<div class="panel panel-red no-radius text-center">
										<div class="panel-body">
											...
											<h2 style="color: white;" class="StepTitle">Health Centers</h2>
...
{
?>
											Total Health Centers :<?php echo htmlentities($num_rows1);  } ?>		
												</a>
...
?>
								...
								<div class="col-sm-4">
									<div class="panel panel-purple no-radius text-center">
										<div class="panel-body">
											<span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-smile-o fa-stack-1x fa-inverse"></i> </span>
											<h2 style="color: white;" class="StepTitle"> Vaccine  Details</h2>
											
											<p class="links cl-effect-1">
												<a style="color: white;" href="display.php">manage details</a>
